...
namespace Mochizuki.VRChat.FukidashiSystem
{
    public class Packaging : EditorWindow
    {
        ...
        [MenuItem("Mochizuki/VRChat/FukidashiSystem/Create Package")]
        ...
        {
            _projectRoot = Path.Combine(Application.dataPath, "Mochizuki", "VRChat", "FukidashiSystem");
        ...
        private void CreatePackage()
        {
            ...
            var destRoot = Path.Combine(Application.dataPath, "Mochizuki", "Packages", $"VRChat-FukidashiSystem-{_version}");
            ...
            var dest = Path.Combine(Application.dataPath, "Mochizuki", "Packages", $"VRChat-FukidashiSystem-{_version}.zip");
            if (File.Exists(dest))
                File.Delete(dest);
